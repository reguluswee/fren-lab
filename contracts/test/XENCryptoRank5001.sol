...
contract XENCrypto5001 is
    Context,
    IRankedMintingToken,
    IStakingToken,
    IBurnableToken,
    ERC20("XEN Crypto 5001", "XEN5001")
{
    ...
    // N.B. modified original contract to test MaxTerm after Global Rank > 5000
    uint256 public constant GENESIS_RANK = 5_001;
