 ...
 */
contract FRENOptionNFT is IERC721, ERC165, IERC721Metadata, Ownable, IMinter, IBurnableFOP {
    ...
    function burnOption(uint256 tokenId) external onlyMinter {
        ...
        address owner = FRENOptionNFT.ownerOf(tokenId);
